...
function ubiq_superadmin_menu() {
	...
	add_submenu_page('ubiq-options-network', __('Network Options', 'ubiq-netopts'), __('Network Options', 'ubiq-netopts'), 'update_core', 'ubiq-options-ubiq_options_network', 'ubiq_options_network'); #wp
}
